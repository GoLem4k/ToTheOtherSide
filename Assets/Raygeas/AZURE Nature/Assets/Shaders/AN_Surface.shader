	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_SurfaceAlbedo = input.ase_texcoord6.xy * _SurfaceAlbedo_ST.xy + _SurfaceAlbedo_ST.zw;
				...
				float staticSwitch164 = input.ase_texcoord7.xyz.y;
				#else
				float staticSwitch164 = NormalWS.y;
				#endif
				...
				float2 uv_SurfaceNormal = input.ase_texcoord6.xy * _SurfaceNormal_ST.xy + _SurfaceNormal_ST.zw;
...
ASEEND*/
//CHKSM=B70E548AF919DE71EFD36BC567D6E2BF17675F2D